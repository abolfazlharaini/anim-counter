...
const AnimCounter = props => {
  ...
  return /*#__PURE__*/React.createElement(_AnimCounter.Root, {
    className: (_props$classes = props.classes) === null || _props$classes === void 0 ? void 0 : _props$classes.root
  }, /*#__PURE__*/React.createElement(_AnimCounter.Button, {
    className: (_props$classes2 = props.classes) === null || _props$classes2 === void 0 ? void 0 : _props$classes2.minus,
    onClick: onClickMinusBtn
  }, (_props$minusIcon = props.minusIcon) !== null && _props$minusIcon !== void 0 ? _props$minusIcon : /*#__PURE__*/React.createElement(_MinusIcon.default, null)), /*#__PURE__*/React.createElement(_AnimCounter.LabelWrapper, {
    ...
    return /*#__PURE__*/React.createElement(_AnimCounter.Label, {
      key: item.id,
      children: item.value,
  ...
  }, (_props$plusIcon = props.plusIcon) !== null && _props$plusIcon !== void 0 ? _props$plusIcon : /*#__PURE__*/React.createElement(_PlusIcon.default, null)));
};
